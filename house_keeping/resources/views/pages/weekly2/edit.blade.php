...
@section('content')
<div class="text-center fw-bold d-grid gap-2 bg-primary py-5 text-white fs-2">Weekly II <br> (Updating) </div>
<a href="{{route('weekly2.index')}}"><i class="bi bi-arrow-left-circle-fill fs-3"></i></a>

<div class="row">
    <div class="col-lg-12 border border-dark p-3">
        <div class="card">
            <form action="{{route('weekly2.update', $data_id->id)}}" method="post" enctype="multipart/form-data">
                @csrf    
                @method('put')
