...
<a href="{{route('weekly1.index')}}"><i class="bi bi-arrow-left-circle-fill fs-3"></i></a>

<div class="row">
    <div class="col-lg-12 border border-dark p-3">
        <div class="card">
            <form action="{{route('weekly1.update', $data_id->id)}}" method="post" enctype="multipart/form-data">
                @csrf    
                @method('put')
