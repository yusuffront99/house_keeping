...
class WeeklyController3 extends Controller
{
    public function index()
    {
        ...
        $data = Weekly3::get();
        return view('pages.weekly3.index', compact('data','items_b','items_t'));
    }
    ...
    public function edit($id)
    {
        $items_b = EquipmentItem::where('category','B')->get();
        $items_t = EquipmentItem::where('category','T')->get();
        $data_id = Weekly3::where('id', $id)->first();

        return view('pages.weekly3.edit', compact('data_id','items_b','items_t'));
    }
